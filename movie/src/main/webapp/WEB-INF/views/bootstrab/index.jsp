...
<link href="${path}/resources/css/styletest.css" rel="stylesheet" type="text/css" media="all" />
<!-- start plugins -->
...
<div class="container">
	<div class="container_wrap">
		<div class="header_top">
		    <div class="col-sm-3 logo"><a href="index.html"><img src="${path}/resources/image/logo.png" alt=""/></a></div>
			...
			<div class="col-sm-3 header_right">
			   <ul class="header_right_box">
				 <li><img src="${path}/resources/image/p1.png" alt=""/></li>
	   ...
	   <div class="callbacks_container">
	      <ul class="rslides" id="slider">
	        <li><img src="${path}/resources/image/test/banner.jpg" class="img-responsive" alt=""/>
	        	<div class="button">
			      <a href="#" class="hvr-shutter-out-horizontal">Watch Now</a>
			    </div>
			</li>
	        <li><img src="${path}/resources/image/test/banner1.jpg" class="img-responsive" alt=""/>
	        	<div class="button">
			      <a href="#" class="hvr-shutter-out-horizontal">Watch Now</a>
			    </div>
			</li>
	        <li><img src="${path}/resources/image/test/banner2.jpg" class="img-responsive" alt=""/>
	        	<div class="button">
			      <a href="#" class="hvr-shutter-out-horizontal">Watch Now</a>
			    </div>
			</li>
	    ...
	    <div class="banner_desc">
			    	<div class="col-md-9">
			    		<ul class="list_1">
			    			...
			    			<li>Rating <span class="m_1"><img src="${path}/resources/image/rating.png" alt=""/></span></li>
			    		</ul>
			    	</div>
		...
		<div class="box_2">
			<div class="col-md-5 grid_3">
			  ...
			  <div class="col-md-6 grid_4"><a href="single.html">
				  <div class="grid_2">
					<img src="${path}/resources/image/pic1.jpg" class="img-responsive" alt=""/>
					<div class="caption1">
						<ul class="list_3">
			   ...
			   <div class="col-md-6 grid_7">
				   <div class="col_2">
				   	    <ul class="list_4">
			    			...
			    			<li><i class="icon2"> </i><p>215</p></li>
			    			<li><i class="icon3"> </i><p>546</p></li>
			    			<li>Rating : &nbsp;&nbsp;<p><img src="${path}/resources/image/rating1.png" alt=""/></p></li>
			    			<li>Release Date : &nbsp;<span class="m_4">Mar 15, 2015</span> </li>
			    			<div class="clearfix"> </div>
			    		</ul>
			    		<div class="m_5"><a href="single.html"><img src="${path}/resources/image/pic3.jpg" class="img-responsive" alt=""/></a></div>
				   </div>
			 </div>
			   <div class="clearfix"> </div>
			   </div>
			   <div class="row_2">
			   	<a href="single.html"><img src="${path}/resources/image/pic4.jpg" class="img-responsive" alt=""/></a>
			   </div>
			</div>
			<div class="col-md-5 content_right">
			 <div class="row_3">
			  <div class="col-md-6 content_right-box"><a href="single.html">
				<div class="grid_2">
				<img src="${path}/resources/image/pic6.jpg" class="img-responsive" alt=""/>
				<div class="caption1">
						<ul class="list_5">
				    		<li><i class="icon5"> </i><p>3,548</p></li>
				    	</ul>
			   ...
			   <div class="col-md-6 grid_5"><a href="single.html">
				<div class="grid_2">
				<img src="${path}/resources/image/pic7.jpg" class="img-responsive" alt=""/>
				<div class="caption1">
						<ul class="list_5">
				    		<li><i class="icon5"> </i><p>3,548</p></li>
				    	</ul>
			  ...
			  <div class="row_5">
			   ...
			   <div class="col-md-6 m_6"><a href="single.html">
				  <img src="${path}/resources/image/pic8.jpg" class="img-responsive" alt=""/>
			   </a></div>
			  </div>
			</div>
