...
<div style="width: 60%; margin: auto;">
	<form method="post" name="writeform" action="/board/informationWritePro" onsubmit="return writeSave()">
		...
		<input id="subBtn2" type="button" value="취소하기" style="float: right;" onclick="window.history.go(-1); return false;"/>
		
	</form>
</div>
<a href="/board/informationList"></a>
</body>
