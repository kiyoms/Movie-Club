...
<div align="center">
                    <c:if test="${pagination.curRange ne 1 }">
                        <a href="#" onClick="fn_paging('${searchname}','${searchtext}',1)">[처음]</a> 
                    </c:if>
                    <c:if test="${pagination.curPage ne 1}">
                        <a href="#" onClick="fn_paging('${searchname}','${searchtext}','${pagination.prevPage }')">[이전]</a> 
                    </c:if>
              ...
              <!--   <div>
                 ...
                 --> 
<script>//searchname,searchtext,
function fn_paging(searchname,searchtext,curPage){
	   window.location.href = '/board/searchList?searchname='+searchname+'&searchtext='+searchtext+'&curPage='+ curPage;
