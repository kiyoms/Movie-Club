...
<div style="width: 60%; margin: auto;">
	<form method="post" name="writeform" action="/board/informationModifyPro" onsubmit="return writeSave()">
		<input type="hidden" name="writer" style="width: 20%;" value="${id.id}"/><br>
		글제목 : <input type="text" name="title" style="width: 40%;" placeholder="제목" value="${dto.title}"/>
		<br><br> 
