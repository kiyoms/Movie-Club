...
<div class="page-wrapper">
    <div class="container-fluid">
        <div class="col-lg-8" style="float:none;margin:auto;"><!--게시판 넓이 -->
            ...
            <div class="row">
                  <div class="col-lg-12">
                   <button type="button" class="btn btn-outline btn-primary pull-right" onclick="location.href='informationConceptList'">
                      개념글
                      </button>
                      <button type="button" class="btn btn-outline btn-primary pull-right" onclick="location.href='informationWriteForm'">
                      게시글 작성
                      </button>
                  </div>
              </div>
                    ...
                    <table class="table table-hover">
                        ...
                        <c:forEach items="${notice}" var="notice">
                      		 ...
                      		 <c:forEach items="${list}" var="list">
					                ...
					                <td name="bno" id="thick${list.bno}"><a href="/board/informationContent?bno=${list.bno}">                 <c:choose>
...
function fn_paging(curPage){
	   window.location.href = '/board/informationList?curPage='+ curPage;
}
